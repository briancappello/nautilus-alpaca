...
class AlpacaHttpClient(HttpClient):
    ...
    async def get_trades(self, market: str) -> List[Dict[str, Any]]:
        return await self._send_request(
            "GET", f"/stocks/{market}/trades", data_request=True
        )
    ...
    async def get_order_status_by_client_id(self, client_order_id: str) -> Dict[str, Any]:
        ...
        return await self._send_request(
            "GET", f"/v2/orders:by_client_order_id", params=params
        )
    ...
    async def get_bars(
        ...
        response = await self._send_request(
            "GET", f"/stocks/{market}/bars", params=params, data_request=True
        )
    ...
    async def get_quote_ticks(
        ...
        response = await self._send_request(
            "GET", f"/stocks/{market}/quotes", params=params, data_request=True
        )
